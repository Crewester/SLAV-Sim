...
public class FourWayLights : MonoBehaviour
{
    ...
    public void checkgates()
    {
        if (Box1 == true)
        {
            ...
            Mode = random(1);
            if (debug) Debug.Log("Car at Entrance 1");
            entrancesInUse++;
        }
        ...
        if (Box2 == true)
        {
            ...
            Mode = random(2);
            if (debug) Debug.Log("Car at Entrance 2");
            entrancesInUse++;
        }
        ...
        if (Box3 == true)
        {
            ...
            Mode = random(3);
            if (debug) Debug.Log("Car at Entrance 3");
            entrancesInUse++;
        }
        ...
        if (Box4 == true)
        {
            ...
            Mode = random(4);
            if (debug) Debug.Log("Car at Entrance 4");
            entrancesInUse++;
        }

        if (debug) { Debug.Log(entrancesInUse); }
    ...
    {
        int tempmode = Mode;
        yield return new WaitForSeconds(Random.Range(15,101));
        Mode = 0;
